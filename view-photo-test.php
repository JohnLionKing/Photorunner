...
<div class="container">
	...
	{ 
		...
		{
			?>
			<div style="margin-right:30px; margin-bottom:10px; float:right;"><a href="galleries-test.php" style="padding:10px 40px 10px 40px; background-color:#43ace5; color:#fff; font-weight:bold; border:0px; border-radius:3px; font-size:16px;" >Go Back</a></div>
			<?php
		}
	} 
	?>
			...
			if(!empty($list))
			{
				foreach($list as $list)
				{
					...
					<div style="padding-left:10px; padding-right:10px; width:33%; float:left">
						<a href="view-photo-test.php?view=<?php echo base64_encode($list->id); ?>"><img src="<?php echo APP_URL; ?>uploads/photos/bigwatermark/<?php echo $list->webfile; ?>" style="width:165px; height:150px;"/></a>
						<?php 
